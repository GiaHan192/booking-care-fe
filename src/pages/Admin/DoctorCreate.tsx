...
const DoctorCreate = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!imageBase64) {
      toast.error('Vui lòng chọn hình ảnh cho bác sĩ');
      return;
    }
  ...
  return (
    <div className='max-w-4xl mx-auto p-6'>
      <h2 className='text-2xl font-bold mb-6'>Thêm bác sĩ mới</h2>
      ...
      <form onSubmit={handleSubmit} className='space-y-8 bg-white rounded-lg shadow p-6'>
        ...
        {/* Giới thiệu chi tiết - full width */}
        <div className="mt-8">
          ...
          <div className='border rounded-md'>
            <QuillWrapper
              ...
              onChange={(content: string) => setDoctor({ ...doctor, longIntroduction: content })}
              modules={modules}
              formats={formats}
